...
$maphuong = userInfo()->ma_phuong ? userInfo()->ma_phuong : request('PhieuGsSearch.maphuong');
...
<div class="row">
    ...
    <div class="col-md-3">
        <?= $form->field($model, 'date_from')
            ->widget(DatePicker::classname(), ['options' => ['placeholder' => 'Từ ngày giám sát']])->label(false); ?>
    </div>
    <div class="col-md-2">
