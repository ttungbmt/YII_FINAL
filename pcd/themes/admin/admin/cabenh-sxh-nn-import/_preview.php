        ...
        <?php if (!isset($message)): ?>
            ...
            <?= TabularForm::widget([
                ...
                'gridSettings'      => [
                    ...
                    'panel'            => [
                        'heading' => '<h3 class="card-title"><i class="glyphicon glyphicon-book"></i> Danh sách Dịch tễ</h3>',
                        'before'  => false,
                        'after'   => false,
                        'footer' => false,
                    ]
    ...
    <script>
        $(function () {
            $('.pagination li a').click(function (e) {
                ...
                let url = '/admin/cabenh-sxh-nn-import?type=preview'
                $.ajax({
                    url,
                    type: 'POST',
                    data,
            ...
            $('#btnSubmit').click(function (e) {
                ...
                let url = '/admin/cabenh-sxh-nn-import?type=save'
