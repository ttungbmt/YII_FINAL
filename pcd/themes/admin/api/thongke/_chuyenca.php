    ...
    <table class="table">
        ...
        <?php foreach ($tk_chuyenca as $ma => $item):?>
            <tr>
                ...
                <td><a target="_blank" href="<?=url(['/admin/cabenh-sxh', 'CabenhSxhSearch' => ['excepted_tv' => 1, 'loaicabenh' => 0,$item['field'] => $ma]])?>"><?=data_get($item, 'ca_tp')?></a></td>
                ...
                <td><a target="_blank" href="<?=url(['/admin/cabenh-sxh', 'CabenhSxhSearch' => ['excepted_tv' => 1, $item['field'] => $ma]])?>"><?=data_get($item, 'total')?></a></td>
            </tr>
        <?php endforeach;?>
        </tbody>
        <tfoot>
        <tr class="table-active table-border-double">
            ...
            <td><a target="_blank" href="<?=url(['/admin/cabenh-sxh', 'CabenhSxhSearch' => ['excepted_tv' => 1, 'loaicabenh' => 0]])?>"><?=$tk_chuyenca->values()->pluck('ca_tp')->sum()?></a></td>
            ...
            <td><a target="_blank" href="<?=url(['/admin/cabenh-sxh', 'CabenhSxhSearch' => ['excepted_tv' => 1]])?>"><?=$tk_chuyenca->values()->pluck('total')->sum()?></a></td>
        </tr>
        </tfoot>
    </table>
</div>