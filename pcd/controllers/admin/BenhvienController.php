 ...
 */
class BenhvienController extends AppController
{
    protected $permission = 'pcd.benhvien.*';
            ...
            */
            ...
            if ($request->isGet) {
                return [
                    ...
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
                        Html::button('Save', ['class' => 'btn btn-primary', 'typ e' => "submit"])
