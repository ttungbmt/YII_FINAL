...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extends2 = __webpack_require__(825);
	
	var _extends3 = _interopRequireDefault(_extends2);
	
	var _getPrototypeOf = __webpack_require__(1088);
	
	var _getPrototypeOf2 = _interopRequireDefault(_getPrototypeOf);
	
	var _classCallCheck2 = __webpack_require__(1015);
	
	var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);
	
	var _createClass2 = __webpack_require__(1095);
	
	var _createClass3 = _interopRequireDefault(_createClass2);
	
	var _possibleConstructorReturn2 = __webpack_require__(1016);
	
	var _possibleConstructorReturn3 = _interopRequireDefault(_possibleConstructorReturn2);
	
	var _inherits2 = __webpack_require__(1039);
	
	var _inherits3 = _interopRequireDefault(_inherits2);
	
	var _react2 = __webpack_require__(298);
	
	var _react3 = _interopRequireDefault(_react2);
	
	var _reactTransformHmr3 = __webpack_require__(1386);
	...
	var _reactResolver = __webpack_require__(491);
	
	var _lodash = __webpack_require__(957);
	
	var _map = __webpack_require__(1423);
	
	var _PopCabenh = __webpack_require__(1472);
	
	var _PopCabenh2 = _interopRequireDefault(_PopCabenh);
	
	var _sxhActions = __webpack_require__(1473);
	
	var _utils = __webpack_require__(1474);
	...
	var _reactTransformHmr2 = (0, _reactTransformHmr4.default)({
	    filename: 'D:/PROGRAM/laragon/www/dichte/web/core/modules/react-map/app/components/MapLayout.js',
	...
	var Overlay = _map.LayersControl.Overlay;
	
	
	var formatDate = function formatDate(date) {
	    var fromD = arguments.length <= 1 || arguments[1] === undefined ? 'DD-MM-YYYY' : arguments[1];
	    var toD = arguments.length <= 2 || arguments[2] === undefined ? 'YYYY/MM/DD' : arguments[2];
	...
	var MapLayout = _wrapComponent('MapLayout')((_temp = _class = function (_Component) {
	    ...
	    function MapLayout(props, context) {
	        ...
	        _this.showPopup = function (model) {
	            var pin = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
	    ...
	    (0, _createClass3.default)(MapLayout, [{
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            var flyTo = nextProps.flyTo;
	            var sxh_model = nextProps.sxh_model;
	            var sxh_showPopup = nextProps.sxh_showPopup;
	            var sxh_filter = nextProps.sxh_filter;
	            var odsxh_flyto = nextProps.odsxh_flyto;
	        ...
	        value: function getCqlPhuong() {
	            var field = arguments.length <= 0 || arguments[0] === undefined ? 'ma_phuong' : arguments[0];
	            var _hanhchinh = this.hanhchinh;
	            var ma_phuong = _hanhchinh.ma_phuong;
	            var ma_quan = _hanhchinh.ma_quan;
	            var giapranh = _hanhchinh.giapranh;
	        ...
	        value: function getCqlCabenh() {
	            ...
	            var datefrom = _props$sxh_filter.datefrom;
	            var dateto = _props$sxh_filter.dateto;
	            var benhnhan = _props$sxh_filter.benhnhan;
	            var loaibenh = _props$sxh_filter.loaibenh;
	            var _hanhchinh2 = this.hanhchinh;
	            var ma_phuong = _hanhchinh2.ma_phuong;
	            var ma_quan = _hanhchinh2.ma_quan;
	            var giapranh = _hanhchinh2.giapranh;
	        ...
	        value: function getViewParams() {
	            ...
	            var ma_phuong = _hanhchinh3.ma_phuong;
	            var ma_quan = _hanhchinh3.ma_quan;
	            var giapranh = _hanhchinh3.giapranh;
	        ...
	        value: function render() {
	            ...
	            var sxh_showPopup = _props.sxh_showPopup;
	            var sxh_model = _props.sxh_model;
	            var sxh_khoanhvung = _props.sxh_khoanhvung;
	            var odsxh_sxh = _props.odsxh_sxh;
	            var odsxh_model = _props.odsxh_model;
	            ...
	            return _react3.default.createElement(
	                ...
	                _react3.default.createElement(
	                    ...
	                    _react3.default.createElement(
	                        ...
	                        _react3.default.createElement(_map.WMSTileLayer, { url: 'http://pcd.hcmgis.vn/geoserver2/ows?', layers: 'hcm_map:hcm_map' })
	                    ),
	                    _react3.default.createElement(
	                        BaseLayer,
	                        { name: 'Google' },
	                    ...
	                    _react3.default.createElement(
	                        ...
	                        _react3.default.createElement(_map.WMSTileLayer, {
	                            url: 'http://pcd.hcmgis.vn/geoserver2/ows?',
	                    ...
	                    _react3.default.createElement(
	                        Overlay,
	                        { name: 'Ranh tổ' },
	                        _react3.default.createElement(_map.WMSTileLayer, { url: 'http://pcd.hcmgis.vn/geoserver2/ows?', layers: 'dichte:ranh_to', transparent: 'true' })
	                    ),
	                    _react3.default.createElement(
	                        Overlay,
	...
	var mapStateToProps = function mapStateToProps(state) {
	    ...
	    var googleAddr = _state$map.googleAddr;
	    var flyTo = _state$map.flyTo;
	    var _state$sxh = state.sxh;
	    var model = _state$sxh.model;
	    var showPopup = _state$sxh.showPopup;
	    var filter = _state$sxh.filter;
	    var khoanhvung = _state$sxh.khoanhvung;
	    var _state$sxhOdich = state.sxhOdich;
	    var sxhs = _state$sxhOdich.sxhs;
	    var flytoBounds = _state$sxhOdich.flytoBounds;
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(589)(module)))

/***/ }

})
//# sourceMappingURL=0.fdeeca397b29211d85cd.hot-update.js.map