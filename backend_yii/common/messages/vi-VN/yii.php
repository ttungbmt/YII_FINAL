...
return [
    ...
    'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{item} other{items}}.' => 'Hiển thị <b>{begin, number}-{end, number}</b> trong số <b>{totalCount, number}</b> mục.',
