...
class DmController extends ApiController
{
    ...
    public function actionDnc(){
        $query = PtNguyco::find()->limit(20);

        $query->andFilterWhere([
            'maquan' => request()->get('maquan'),
            'maphuong' => request()->get('maphuong'),
        ]);

        $query->andFilterSearch(['ilike', 'ten_cs', request()->get('term')]);
        $query->andWhere('ngayxoa IS NULL');
