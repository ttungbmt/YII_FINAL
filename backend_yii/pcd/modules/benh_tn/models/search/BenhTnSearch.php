<?php
namespace pcd\modules\benh_tn\models\search;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use pcd\modules\benh_tn\models\BenhTn;

/**
 * BenhTnSearch represents the model behind the search form of `pcd\modules\benh_tn\models\BenhTn`.
 */
class BenhTnSearch extends BenhTn
{
    /**
     * {@inheritdoc}
     */
