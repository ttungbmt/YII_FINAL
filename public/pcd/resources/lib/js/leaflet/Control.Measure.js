L.Control.Measure = L.Control.extend({
    ...
    _enable: function() {
        ...
        L.DomUtil.removeClass(this._button, 'leaflet-control-measure-disabled');
        this._map.on('click', this._onMapClick, this);
    },
    _disable: function() {
        this._enabled = false;
         L.DomUtil.addClass(this._button, 'leaflet-control-measure-disabled');
    ...
    _onMapClick: function(e) {
        ...
        if (this._startPoint === null) {
            ...
            var sz  = 'Khoảng cách: ' + (distance > 50000 ? (distance/1000).toFixed(2) + ' km.' : distance.toFixed(2) + ' m.');
