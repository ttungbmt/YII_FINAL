...
$this->title = 'Nhập Excel bệnh truyền nhiễm';
$file = '/pcd/storage/samples/MAU_DICHBENH.xlsx';
?>
...
<div class="card card-white">
    ...
    <div class="card-header header-elements-inline">
        ...
        <div class="heading-elements">
            <?= Html::a('<i class="icon-file-download"></i> Tải file mẫu', $file,['id' => 'btn-download', 'class' => 'btn btn-link']) ?>
        </div>
    </div>
    <div class="card-body">
        <div class="row">
    ...
    <script>
        $(function () {
            ...
            $('#uploadForm').submit(function (e) {
                ...
                l.start()
                const api = postApi(`/import/dichbenh?type=preview`, data)
                api.done(res => {
                    l.stop()
            ...
            $('#btnSaveAll').click(function (e) {
                ...
                const api = postApi(`/import/dichbenh?type=save-all`, data)
                l.start()
                api.done(res => {
                    l.stop()
                    $('#importResp').html(res.html)
