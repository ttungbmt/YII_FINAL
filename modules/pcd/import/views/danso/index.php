...
$this->title = 'Nhập xét nghiệp huyết thanh';
$file = '/pcd/storage/samples/MAU_HUYETTHANH.xlsx';
?>
    ...
    <script>
        $(function () {
            ...
            $('#uploadForm').submit(function (e) {
                ...
                l.start()
                const api = postApi(`/import/danso?type=preview`, data)
                api.done(res => {
                    l.stop()
            ...
            $('#btnSaveAll').click(function (e) {
                ...
                const api = postApi(`/import/danso?type=save-all`, data)
                l.start()
                api.done(res => {
                    l.stop()
                    $('#importResp').html(res.html)
